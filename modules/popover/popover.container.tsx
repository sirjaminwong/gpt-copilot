  ...
  const renderPanel = () => {
    ...
    if (data) {
      ...
      <StyledContent>
        ...
        <div>uk: {data.phonetic.uk} <PhoneOutlined rev={''} onClick={() => handleSpeech(textSelection.text, 'en-GB')} /></div>
        <div>us: {data.phonetic.us} <PhoneOutlined rev={''} onClick={() => handleSpeech(textSelection.text)} /></div>
        ...
        <p>
          ...
          <div key={i.english}>
            <div><PhoneOutlined onClick={() => handleSpeech(i.english)} rev={undefined} /> {i.english}</div>
            <div>{i.chinese}</div>
          </div>))}
        </p>
        <p>
